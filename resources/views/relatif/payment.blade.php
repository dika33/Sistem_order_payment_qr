            ...
            <div class="w-full bg-[#2A1D17]/40 border border-[#594238]/60 rounded-xl p-6 flex flex-col gap-4 shadow-md">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="flex flex-col gap-1.5">
                        ...
                        <input type="password" id="card-cvv" placeholder="â€¢â€¢â€¢" maxlength="3" class="w-full bg-[#1C110B] border border-[#594238] focus:border-[#FFB595] text-[#F6DDD4] font-mono text-sm rounded-lg focus:outline-none focus:ring-0 py-3 px-4 placeholder-[#E0C0B2]/20 text-center" autocomplete="off" required>
                    </div>
                </div>
            </div>
        </section>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (numberInput) {
                numberInput.addEventListener('input', (e) => {
                    ...
                    document.getElementById('card-graphic-number').textContent = e.target.value.length > 0 ? e.target.value : 'â€¢â€¢â€¢â€¢ â€¢â€¢â€¢â€¢ â€¢â€¢â€¢â€¢ â€¢â€¢â€¢â€¢';
                });
            }
